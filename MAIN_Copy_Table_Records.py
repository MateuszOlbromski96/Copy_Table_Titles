import mysql.connector as mc #connecting to mysql db
import time #measuring execution time
from getpass import getpass #hiding the password being typed. Works very poorly in RUN mode, cause it
...
if __name__ == '__main__':
    try:
        ...
        #establishing connection to database with source table
